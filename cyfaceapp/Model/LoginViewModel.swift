...
class LoginViewModel: ObservableObject {
    ...
    // TODO: @Published var authenticator: CredentialsAuthenticator?
    ...
    init(settings: Settings) {
        ...
        if let authenticatedServerURL = settings.authenticatedServerUrl  {
            if authenticatedServerURL == settings.serverUrl {
                do {
                    // TODO: self.authenticator = try createAuthenticator()
                } catch {
    ...
    func login(onSuccess: @escaping ()->(), onFailure: @escaping (Error) -> Void) throws {
        /* TODO: let authenticator = try createAuthenticator()
    ...
    /* TODO: private func createAuthenticator() throws -> CredentialsAuthenticator {
